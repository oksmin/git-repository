...
public class PageMaker {
	...
	public void init() {
		...
		this.endPage =  (int) Math.ceil( (cri.getPageNum() * 1.0) / this.displayPageAmount) * this.displayPageAmount ; // 8 -> 8 / diplayPageAmount -> 1 * displayPageAmount
	...
	public static void main(String[] args){
		...
		System.out.println((int) Math.ceil(339 /5 )); // 1.0을 해줘야함. 이러면 안됨
		*/
	}
