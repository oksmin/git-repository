                           		...
                           		<!-- ---------------------------------------- -->
	                                ...
	                                <table id="datatablesSimple">
	                                    ...
	                                    <tbody>
											...
											<tr>
												<td>${boardVO.b_no}</td><!-- pageScope에 vo가 생성되었다.  -->
												<td><a href="${pageContext.servletContext.contextPath }/board?method=get&b_no=${boardVO.b_no}">${boardVO.title}</a></td>
												<td>${boardVO.id}</td>
